...
@Component({
  selector: 'app-mea-export-type5',
  templateUrl: './mea-export-type5.component.html',
  styleUrls: ['./mea-export-type5.component.scss'],
})
export class MeaExportType5Component implements OnInit {
  @Input() item!: any;
