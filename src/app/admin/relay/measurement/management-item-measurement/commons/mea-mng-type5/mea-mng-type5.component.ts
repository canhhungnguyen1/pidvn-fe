...
@Component({
  selector: 'app-mea-mng-type5',
  templateUrl: './mea-mng-type5.component.html',
  styleUrls: ['./mea-mng-type5.component.scss']
})
export class MeaMngType5Component implements OnInit {
