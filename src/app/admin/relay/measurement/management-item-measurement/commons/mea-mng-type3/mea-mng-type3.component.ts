...
@Component({
  selector: 'app-mea-mng-type3',
  templateUrl: './mea-mng-type3.component.html',
  styleUrls: ['./mea-mng-type3.component.scss'],
})
export class MeaMngType3Component implements OnInit {
