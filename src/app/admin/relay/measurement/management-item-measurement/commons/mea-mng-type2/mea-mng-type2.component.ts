...
@Component({
  selector: 'app-mea-mng-type2',
  templateUrl: './mea-mng-type2.component.html',
  styleUrls: ['./mea-mng-type2.component.scss'],
})
export class MeaMngType2Component implements OnInit {
  @Input() item!: any;
  @Input() images!: any;
  @Input() standard!: any;
