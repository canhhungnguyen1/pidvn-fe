...
@Component({
  selector: 'app-mea-mng-edit-type2',
  templateUrl: './mea-mng-edit-type2.component.html',
  styleUrls: ['./mea-mng-edit-type2.component.scss'],
})
export class MeaMngEditType2Component implements OnInit {
  @Input() item!: any;
