...
@Component({
  selector: 'app-mea-mng-edit-type5',
  templateUrl: './mea-mng-edit-type5.component.html',
  styleUrls: ['./mea-mng-edit-type5.component.scss'],
})
export class MeaMngEditType5Component implements OnInit {
  @Input() item!: any;
