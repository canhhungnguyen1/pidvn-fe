...
@Component({
  selector: 'app-mea-mng-edit-type4',
  templateUrl: './mea-mng-edit-type4.component.html',
  styleUrls: ['./mea-mng-edit-type4.component.scss'],
})
export class MeaMngEditType4Component implements OnInit {
  @Input() item!: any;
