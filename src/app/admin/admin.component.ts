...
export class AdminComponent implements OnInit {
  ...
  skillMapVrEncLinks = [
    ...
    {
      line: '11G1-OUT-1',
      link: `${this.baseUrlJava}/pidvn/ma/skillmap/checkskill?line=11G1-OUT-1`,
    },
    {
      line: '11G1-OUT-2',
      link: `${this.baseUrlJava}/pidvn/ma/skillmap/checkskill?line=11G1-OUT-2`,
    },
    {
      line: '11G2-OUT-1',
  ...
  ngOnInit(): void {
    ...
    this.createSupplierLink = `${this.baseUrlJava}/pidvn/acc/supplier/menu?accessToken=${token2}`;
